...
import com.lta.backend.service.KafkaMessageService;
...
public class StrConsumerListener {
    ...
    public void listener1(String message) {
        ...
        log.info("LISTENER1 ::: Mensaje persistido en base de datos");
    }
    ...
    public void listener2(String message) {
        ...
        kafkaMessageService.saveMessage(message);
        log.info("LISTENER2 ::: Mensaje persistido en base de datos");
    }
    ...
    public void listener3(String message) {
        ...
        kafkaMessageService.saveMessage(message);
        log.info("LISTENER3 ::: Mensaje persistido en base de datos");
    }
}
